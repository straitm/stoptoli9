...
double gc_vessel_beta_count_low_guess_with_mu_selection(){ return looseD24()*muon_selection_efficiency_at_gc_vessel; }
...
double looseI18(){ return n_c12cap-n_c12captarget; }
