...
//#include "ehistsig.C"
  ...
  li8mc.Draw("ctEvisID >> li8spec", "ctX[0]**2 + ctX[1]**2 < (1150*1.2)**2 && abs(ctX[2]) < 1229*1.2");
  ...
  for(int j = 1; j < 4; j++){
    ...
    TH1D * bg_plus_li8_plus_he6 = (TH1D*)bg_plus_li8->Clone(Form("bg_plus_li8_plus_he6_%d", j));
    bg_plus_li8_plus_he6->Add(he6spec_p);
